...
-- 자주 사용되는 컬럼은 PK 지정 또는 UNIQUE 지정을 통해 인덱스 설정
...
BEGIN
    ...
    VALUES
        (SIGN_OUT_NO_SEQ.NEXTVAL, :OLD.MEMBER_NO, :OLD.ID, :OLD.NAME, :OLD.EMAIL, :OLD.AGREE_STATE);
